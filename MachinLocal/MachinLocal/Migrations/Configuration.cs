namespace MachinLocal.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MachinLocal.Models.MachinLocalDbContext>
    {
        ...
        protected override void Seed(MachinLocal.Models.MachinLocalDbContext context)
        {
...

            {
                try
                {
                    ...
                    servicios.Add(new Servicio()
                    {
                        ...
                        Descripcion = "se ajustan las llantas de un vehículo para que miren hacia el frente y los pesos de una llanta",
                        Costo = 600
                    });
                    servicios.Add(new Servicio()
                    {
